...
public class Minesweeper extends JFrame implements MouseListener
{
    ...
    public void newGame()
    {
        ...
        for(int i = 0; i < SIZE*SIZE/6; i++){
            ...
            grid[randomRow][randomCol].setText("bomb");
        }
    }
    ...
    public void gameWon()
    {
        ...
        // {
            // highScorePanel = new Score(time);
        // } else
        // {
            // highScorePanel.addScore(time, null);
        // }
        // highScorePanel.setVisible(true);
        new Score(time, this);
        choice = JOptionPane.showOptionDialog (null, "Would you like to play agian?", "Play again?", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options [0]);
